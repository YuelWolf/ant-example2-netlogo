...
to go
  ...
  [
    ...
    forward random max-steps-size
    if pcolor = green ; if the turtle is located an a green patch
    [
      set pcolor black
...
"" ""
PENS
"Totoa-food-eaten" 1.0 0 -16777216 true "" "plot sum [food-eaten] of turtles"
